...
__simd_vf__ void
ProcessVec1NoUpdateGeneralImpl128VF(__ubuf__ T2 *expUb, __ubuf__ T2 *x_expUb, __ubuf__ T *expSumUb, __ubuf__ T *maxUb,
                                    __ubuf__ T *maxUbStart, __ubuf__ T *srcUb, __ubuf__ uint8_t *indexesUb,
                                    __ubuf__ uint32_t *maskUb, __ubuf__ uint32_t *maskUbUnroll, const uint32_t nPadding,
                                    const uint32_t blockStride, const uint32_t repeatStride, const uint32_t oriTailN,
                                    const uint32_t tailN, const float dScale, uint32_t pltOriTailN, uint32_t pltTailN,
...
ProcessVec1NoUpdateGeneralImpl128(const LocalTensor<T2> &dstTensor, const LocalTensor<uint8_t> &indexesTensor,
                                  ...
                                  const uint16_t m, const uint32_t originN, const T scale, const T minValue)
{
    ...
    ProcessVec1NoUpdateGeneralImpl128VF<T, T2, s1BaseSize, s2BaseSize, hasAttn>(
        expUb, x_expUb, expSumUb, maxUb, maxUbStart, srcUb, indexesUb, maskUb, maskUbUnroll, nPadding, blockStride,
        repeatStride, oriTailN, tailN, scale, pltOriTailN, pltTailN, m, scale, minValue);
}
#endif
} // namespace FaVectorApi
