...
if _TORCHAIR_AVAILABLE:
    @register_fx_node_ge_converter(torch.ops.npu_ops_transformer.npu_lightning_indexer_v2_metadata.default)
    def convert_npu_lightning_indexer_v2_metadata(
        ...
        raise RuntimeError("GE converter doesn't support op: 'npu_lightning_indexer_v2_metadata'")
