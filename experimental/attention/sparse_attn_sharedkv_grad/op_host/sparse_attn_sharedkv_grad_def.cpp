...
/*!
 * \file sparse_attn_sharedkv_grad_def.cpp
 * \brief
 */
...
namespace ops {
class SparseAttnSharedkvGrad : public OpDef {
public:
    explicit SparseAttnSharedkvGrad(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
