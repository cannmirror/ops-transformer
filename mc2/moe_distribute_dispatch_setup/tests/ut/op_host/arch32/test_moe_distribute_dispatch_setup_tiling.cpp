...
/*!
 * \file test_moe_distribute_dispatch_setup_tiling_arch32.cpp
 * \brief arch32 tiling UT
 */
...
namespace MoeDistributeDispatchSetupArch32UT {

static const std::string OP_NAME = "MoeDistributeDispatchSetup";

struct MoeDistributeDispatchSetupArch32TestParam {
    std::string caseName;
...
inline std::ostream &operator<<(std::ostream &os, const MoeDistributeDispatchSetupArch32TestParam &param)
{
    return os << param.caseName;
}

static MoeDistributeDispatchSetupArch32TestParam g_arch32TestCases[] = {
    {"test_moe_distribute_dispatch_setup_arch32_normal_fp16_bs8_h7168_k8",
     {8, 7168},
     ge::DT_FLOAT16,
     ge::FORMAT_ND,
     {8, 8},
     ...
     {},
     0},
    {"test_moe_distribute_dispatch_setup_arch32_normal_bf16_bs8_h7168_k8",
     {8, 7168},
     ge::DT_BF16,
     ge::FORMAT_ND,
     {8, 8},
     ...
     {},
     0},
    {"test_moe_distribute_dispatch_setup_arch32_with_scales",
     {8, 7168},
     ge::DT_FLOAT16,
     ge::FORMAT_ND,
     {8, 8},
     ...
     {},
     0},
    {"test_moe_distribute_dispatch_setup_arch32_ep4_bs8",
     {8, 7168},
     ge::DT_FLOAT16,
     ge::FORMAT_ND,
     {8, 8},
...
class MoeDistributeDispatchSetupArch32TilingTest
    : public testing::TestWithParam<MoeDistributeDispatchSetupArch32TestParam> {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MoeDistributeDispatchSetupArch32TilingTest SetUp." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MoeDistributeDispatchSetupArch32TilingTest TearDown." << std::endl;
    }
};
...
static gert::TilingContextPara BuildTilingContextPara(const MoeDistributeDispatchSetupArch32TestParam &param)
{
...
TEST_P(MoeDistributeDispatchSetupArch32TilingTest, GeneralCases)
{
    auto param = GetParam();
...
INSTANTIATE_TEST_CASE_P(MoeDistributeDispatchSetupArch32TilingUT, MoeDistributeDispatchSetupArch32TilingTest,
                        testing::ValuesIn(g_arch32TestCases));
