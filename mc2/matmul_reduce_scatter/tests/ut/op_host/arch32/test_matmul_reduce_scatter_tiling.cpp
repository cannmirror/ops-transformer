...
TEST_F(MatmulReduceScatterArch32TilingTest, MataInterleave_FP16)
{
...
TEST_F(MatmulReduceScatterArch32TilingTest, SmallN_FP16)
{
    struct MatmulReduceScatterCompileInfo {
    } compileInfo;
    uint64_t coreNum = 20;
...
TEST_F(MatmulReduceScatterArch32TilingTest, SmallK_TransB_FP16)
{
    struct MatmulReduceScatterCompileInfo {
    } compileInfo;
    uint64_t coreNum = 20;
...
TEST_F(MatmulReduceScatterArch32TilingTest, LargeD_TransB_DTailBranch_FP16)
{
    struct MatmulReduceScatterCompileInfo {
    } compileInfo;
    uint64_t coreNum = 20;
...
TEST_F(MatmulReduceScatterArch32TilingTest, LargeD_TransB_DTailBaseD0_FP16)
{
    struct MatmulReduceScatterCompileInfo {
    } compileInfo;
    uint64_t coreNum = 20;
...
TEST_F(MatmulReduceScatterArch32TilingTest, RankSize2_FP16)
{
    struct MatmulReduceScatterCompileInfo {
    } compileInfo;
    uint64_t coreNum = 20;
...
TEST_F(MatmulReduceScatterArch32TilingTest, RankSize16_FP16)
{
    struct MatmulReduceScatterCompileInfo {
    } compileInfo;
    uint64_t coreNum = 20;
...
TEST_F(MatmulReduceScatterArch32TilingTest, TransB_NeqK_FP16)
{
    struct MatmulReduceScatterCompileInfo {
    } compileInfo;
    uint64_t coreNum = 20;
...
TEST_F(MatmulReduceScatterArch32TilingTest, CheckUbOverflowSmallD_FP16)
{
    struct MatmulReduceScatterCompileInfo {
    } compileInfo;
    uint64_t coreNum = 20;
...
TEST_F(MatmulReduceScatterArch32TilingTest, CheckUbOverflowLargeD_FP16)
{
    struct MatmulReduceScatterCompileInfo {
    } compileInfo;
    uint64_t coreNum = 20;
...
TEST_F(MatmulReduceScatterArch32TilingTest, IsDeterministic_True_FP16)
{
...
TEST_F(MatmulReduceScatterArch32TilingTest, IsDeterministic_False_FP16)
{
    const char* envValue = getenv("HCCL_DETERMINISTIC");
    std::string originalStr = (envValue != nullptr) ? std::string(envValue) : "";
