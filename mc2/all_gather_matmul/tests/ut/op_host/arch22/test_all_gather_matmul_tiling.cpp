...
class AllGatherMatmulArch22TilingTest : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "AllGatherMatmulArch22TilingTest SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "AllGatherMatmulArch22TilingTest TearDown" << std::endl;
    }
};

TEST_F(AllGatherMatmulArch22TilingTest, Float16Test1)
{
...
TEST_F(AllGatherMatmulArch22TilingTest, Float16Test2)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, Float16Test3)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, Bfloat16)
{
    // tilingFunc simulate
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, Float16TestL2cache)
{
    // tilingFunc simulate
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, N0)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, TestReduceAlignLenWithStrongTpBound)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, TestHugeKValue)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
// 覆盖带宽按shape增长的切分策略
TEST_F(AllGatherMatmulArch22TilingTest, TestBwGrowthByLargeKN)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, TestStrongTpBoundCommBoundFront)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, TestBwGrowthByShapeLargeM)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, TestRankDim2CalcBoundSmallN)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, TestSoc910BMeshTopo)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, TestStorageGatherFalseGatherIdx0)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, TestInvalidGatherIndex1)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
...
TEST_F(AllGatherMatmulArch22TilingTest, TestBShapeMismatchTransB)
{
    struct AllGatherMatmulCompileInfo {} compileInfo;
