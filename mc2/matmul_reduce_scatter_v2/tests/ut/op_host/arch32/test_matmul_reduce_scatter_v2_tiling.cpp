...
protected:
    ...
    {
        std::cout << "MatmulReduceScatterV2 Arch32TilingTest SetUp" << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "MatmulReduceScatterV2 Arch32TilingTest TearDown" << std::endl;
    }
};
...
INSTANTIATE_TEST_SUITE_P(
    MatmulReduceScatterV2, MatmulReduceScatterV2Arch32TilingTest,
