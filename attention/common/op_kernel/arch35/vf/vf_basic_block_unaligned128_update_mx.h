    ...
    const float deSCaleKValue = 1.0f, const float sinkValue = 0.0f, const float pScale = 1.0f)
{
    ...
    if (subLoop == 0){
        ProcessVec1UpdateGeneralImpl128Mxfp8FullquantVFSubloop0<T, T2, pseShiftType, s1BaseSize, s2BaseSize, hasAtten, pseMode, hasDrop,
            ...
            tmpExpSumUb2, tmpMaxUb, tmpMaxUb2, indexesUb, maskUb, maskUbUnroll, dropMaskUb, preLoopMaxUb, 
            preLoopSumUb, firstLoopSumUb, nPadding, blockStride, repeatStride, oriTailN, tailN, dScale, 
            pltOriTailN, pltTailN, divValue, pltN, m, pseStride, slopes, posShift, scale, dScaleQK,
            minValue, deSCaleKValue, sinkValue, pScale);
    } else {
        ProcessVec1UpdateGeneralImpl128Mxfp8FullquantVFSubloop1<T, T2, pseShiftType, s1BaseSize, s2BaseSize, hasAtten, pseMode, hasDrop,
            isMlaSgd, isMlaFullQuant, hasSink>(
            expUb, x_expUb, pseUb, maxUb, maxUbStart, srcUb, expMaxUb, inMaxUb, expSumUb, inExpSumUb, tmpExpSumUb,
            tmpExpSumUb2, tmpMaxUb, tmpMaxUb2,indexesUb, maskUb, maskUbUnroll, dropMaskUb, preLoopMaxUb,
            preLoopSumUb, firstLoopSumUb, nPadding, blockStride, repeatStride, oriTailN, tailN, dScale, 
