...
* 确定性计算：
   - <term>Atlas A2 训练产品</term>、<term>Atlas A3 训练产品</term>：aclnnBlockSparseAttentionGrad默认确定性实现。
   - <term>Ascend 950PR/Ascend 950DT</term>：aclnnBlockSparseAttentionGrad默认非确定性实现，不支持配置开启。
