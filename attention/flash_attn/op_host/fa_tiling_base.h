...
/*!
 * \file fa_tiling_base.h
 * \brief
 */

#ifndef FLASH_ATTN_FA_TILING_BASE_H
#define FLASH_ATTN_FA_TILING_BASE_H
...
class FaTilingBase {
public:
    FaTilingBase() = default;

    explicit FaTilingBase(gert::TilingContext *context) : context_(context)
    {
    }

    virtual ~FaTilingBase() = default;
...
#endif // FLASH_ATTN_FA_TILING_BASE_H